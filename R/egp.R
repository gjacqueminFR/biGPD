...
extgp.nll <- function(theta, x, censoring, rounded, type) {
    ...
    if (type == 0) {
        if (theta[1] <= 0 | theta[2] <= -0.5 | theta[2] > 0.99) {
            return(Inf)
        } else {
        ...
        if (theta[1] <= 0 | theta[2] <= 0 | theta[3] <= -0.5 | theta[3] > 0.99) {
            return(Inf)
        } else {
        ...
        if (theta[1] <= 0 | theta[1] > 100 | theta[2] <= 0 | theta[3] <= -0.5 | theta[3] > 0.99) {
            return(Inf)
        } else {
        ...
        if (theta[1] <= 0 | theta[2] <= 0 | theta[2] > 100 | theta[3] <= 0 | theta[4] <= -0.5 | theta[4] > 0.99) {
            return(Inf)
        } else {
        ...
        if (theta[1] < 0 | theta[1] > 1 | theta[2] <= 0 | theta[3] <= 0 | theta[4] <= 0 | theta[5] <= -0.5 | theta[5] > 0.99 |
            theta[3] < theta[2]) {
            return(Inf)
        } else {
